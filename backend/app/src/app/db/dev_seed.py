...
DEMO_ORDERS: list[dict[str, Any]] = [
    ...
    # Extended history for Priya Verma (customer@khanabazaar.dev) — spans
    # multiple addresses, services, and statuses so the customer dashboard
    # has a populated "Past orders" timeline plus a few in-flight rows.
    {
        "customer_email": "customer@khanabazaar.dev",
        "store_name": "Sharma General Store",
        "service_slug": "grocery",
